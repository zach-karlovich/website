  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <Link href="/blog" className="bg-nord10 hover:bg-nord11 text-nord0 font-bold py-4 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center">
          <FaBlog className="mr-2" /> Read Blog
        </Link>
      ...
      <div className="mt-6 p-6 bg-nord2 rounded-lg shadow-lg max-w-md w-full backdrop-blur-sm bg-opacity-80">
        <h2 className="text-2xl font-bold text-nord6 mb-4">Latest Blog Post</h2>
        <p className="text-nord4 mb-4">Check out my most recent thoughts and insights on technology and development.</p>
        <Link href="/blog" className="text-nord8 hover:text-nord9 font-semibold">
          Read More →
        </Link>
      </div>
    </div>
